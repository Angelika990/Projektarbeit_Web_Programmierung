...
x.style.display = "block";
  if (x.style.display === "none") {
    ...
    x.style.display = "none"; //verstecken
  }
}
function showDiv() {
...
// Neuer Listeneintrag erstellen
function neuerEintrag() {
  var li = document.createElement("li");

//Hier wird beschrieben, in welcher Form der fertige Eintrag angezeigt werden soll
...
//Hier wird sichergestellt, dass alle Felder ausgefüllt wurden
  ...
  // Lösch-Button wird zu jedem Eintrag hinzugefügt
